...
const OrderScreen = () => {
  ...
  return (
    <div style={{ backgroundColor: "#006991", minHeight: "100vh", padding: "20px" }}>
      <h1 className="text-center mb-4" style={{ color: "#ffffff" , marginTop: "20px" }}>Your Orders</h1>
      ...
      {orders && orders.length === 0 ? (
        ...
        <Table striped bordered hover responsive variant="light">
          <thead style={{ backgroundColor: "#ffffff", color: "#006991" }}>
            <tr>
              <th>Order ID</th>
